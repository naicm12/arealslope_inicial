...
with st.form("Informativo", border=False):
    ...
    st.write(" Nas demais categorias do percurso de 21km haverá premiação somente de troféus.")
    st.write(" No percurso de 14km haverá premiação de troféus do 1º ao 5º colocados nas categorias geral e por idade para masculino e feminino.")        
